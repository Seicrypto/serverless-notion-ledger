...
export interface ApiClientLike {
	...
	getOrganizationsById: OpenApiClient['getOrganizationsById'];
	deleteOrganizationsById: OpenApiClient['deleteOrganizationsById'];
	patchOrganizationsById: OpenApiClient['patchOrganizationsById'];
	getOrganizationsByIdCharacters: OpenApiClient['getOrganizationsByIdCharacters'];
	postOrganizationsByIdCharacters: OpenApiClient['postOrganizationsByIdCharacters'];
	getOrganizationsByIdMembers: OpenApiClient['getOrganizationsByIdMembers'];
	postOrganizationsByIdMembers: OpenApiClient['postOrganizationsByIdMembers'];
	postOrganizationsByIdMembersApply: OpenApiClient['postOrganizationsByIdMembersApply'];
	postOrganizationsByIdMembersByMemberIdApprove: OpenApiClient['postOrganizationsByIdMembersByMemberIdApprove'];
