...
export type ApiOperations = {
	...
	getOrganizationsByOrganizationLedgerEventsSummary: { pathParams: { "organization": string; }; query: { "fromOccurredAt"?: string; "gameId": number; "limit"?: number; "offset"?: number | unknown; "status"?: "open" | "ready_for_settlement" | "partially_settled" | "settled" | "cancelled"; "statusGroup"?: "unsettled" | "settleable" | "settled" | "cancelled"; "toOccurredAt"?: string; }; response: LedgerEventSummaryLookupResponse; };
